    ...
    return (
        <div className="ReadSneakers">
            <div className="banner">
                ...
                <p className="welcome-paragraph">Thank you for joining us on this exciting journey through sneaker culture, fashion, and innovation. <br /> We invite you to explore, discover, and be inspired as we continue to fuel our passion and yours.</p> <br />
            </div>
